    ...
    <div className="flex flex-col gap-3 h-full min-h-0">
      ...
      <div className="flex items-center gap-2 flex-wrap px-1">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium bg-indigo-600 text-white hover:bg-indigo-700 active:scale-95 transition-all shadow-sm"
        >
